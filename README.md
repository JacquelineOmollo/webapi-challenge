...
- [x] Describe Middleware?
      Middleware can either return the response or call the next middleware in the pipeline.
- [x] Describe a Resource?
      When constructing a REST API each HTTP method corresponds to an action against a resource served by the API. CRUD
- [x] What can the API return to help clients know if a request was successful?
      A message and a status code.
- [x] How can we partition our application into sub-applications?
      Provides flexibility and allow me to keep my code clean. But I see other benefits, such as keeping code for various routes completely separate.
